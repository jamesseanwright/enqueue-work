...
describe('Worker', function () {
    ...
    describe('the enqueue method', function () {
        it('should enqueue the payload to the child process and proxy the result', async function () {
            const requestId = 1;
            ...
            const actualResult = await worker.enqueue(payload);
